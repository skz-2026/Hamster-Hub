...
export const pages: Record<keyof typeof pagesZh, string> = {
  ...
  'pages.workbench.edit': 'Edit',
  'pages.workbench.editHint': 'Edit home tiles (or long-press any tile)',
  'pages.workbench.done': 'Done',
  'pages.workbench.addTile': 'Add tile',
  'pages.workbench.allAdded': 'All tiles are already added',
  'pages.workbench.removeTile': 'Remove tile',
  'pages.workbench.spanToggle': 'Toggle tile width',
  'pages.workbench.emptyTitle': 'No tiles yet — tap "Edit → +" to add some',
  'pages.workbench.focus': 'Focus Timer',
  'pages.workbench.focus.today': '{n} min today',
  'pages.workbench.focus.paused': 'Paused',
  'pages.workbench.focus.onBreak': 'On break ☕',
  'pages.workbench.focus.onFocus': 'Focusing 🐹',
  'pages.workbench.focus.resume': 'Resume',
  'pages.workbench.focus.pause': 'Pause',
  'pages.workbench.focus.stop': 'Stop',
  'pages.workbench.focus.start25': 'Focus 25 min',
  'pages.workbench.focus.break5': 'Break 5 min',
  'pages.workbench.focus.trayHint': 'Keeps counting even when minimized',
};
