...
export const pages = {
  ...
  'pages.cat.system': '系统',
  'pages.cat.other': '其他',
  'pages.workbench.edit': '编辑',
  'pages.workbench.editHint': '编辑首页卡片（也可长按任意卡片）',
  'pages.workbench.done': '完成',
  'pages.workbench.addTile': '添加卡片',
  'pages.workbench.allAdded': '所有卡片都已添加',
  'pages.workbench.removeTile': '移除卡片',
  'pages.workbench.spanToggle': '切换卡片宽度',
  'pages.workbench.emptyTitle': '还没有卡片，点右上角「编辑 → +」添加',
  'pages.workbench.focus': '番茄钟',
  'pages.workbench.focus.today': '今日 {n} 分钟',
  'pages.workbench.focus.paused': '已暂停',
  'pages.workbench.focus.onBreak': '休息中 ☕',
  'pages.workbench.focus.onFocus': '专注中 🐹',
  'pages.workbench.focus.resume': '继续',
  'pages.workbench.focus.pause': '暂停',
  'pages.workbench.focus.stop': '结束',
  'pages.workbench.focus.start25': '专注 25 分钟',
  'pages.workbench.focus.break5': '休息 5 分钟',
  'pages.workbench.focus.trayHint': '收进托盘也照常计时',
} as const;
