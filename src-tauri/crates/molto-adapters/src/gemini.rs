...
impl AgentAdapter for GeminiAdapter {
    ...
    /// 跨 Agent 会话共享 skill（v2.4）：~/.gemini/skills/molto-session-resolver/SKILL.md
...
mod tests {
  ...
  "mcpServers": {
    ...
    fn roundtrip_read_render_read() {
        ...
        // hooks / unknownField 等与 Molto 无关的内容原样保留
    ...
    fn runtime_declares_acp_channel_and_skills() {
        ...
        assert!(skill.contains("molto://session/<agent>/<sessionKey>"));
    }
