...
use molto_core::{LiveSessionInfo, SessionKind};
...
impl PtySession {
    ...
    pub fn write(&self, data: &[u8]) -> Result<()> {
        let mut last_err: Option<MoltoError> = None;
    ...
    pub fn info(&self) -> LiveSessionInfo {
        ...
        LiveSessionInfo {
            ...
            kind: st.kind,
            channel: molto_core::SessionChannel::Pty,
...
fn spawn_reader_thread(
    ...
    std::thread::Builder::new()
        ...
        .map_err(|e| MoltoError::Other(format!("PTY 读取线程启动失败：{e}")))?;
    ...
    std::thread::Builder::new()
        ...
        .map(|_| ())
        .map_err(|e| MoltoError::Other(format!("PTY 合帧线程启动失败：{e}")))
}
...
fn spawn_wait_thread(
    ...
    std::thread::Builder::new()
        ...
        .map(|_| ())
        .map_err(|e| MoltoError::Other(format!("PTY 等待线程启动失败：{e}")))
}
